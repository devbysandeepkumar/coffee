...
const Navbar = () => {
  return (
    <main className="w-44 h-100 fixed right-15 top-5 bg-[#1B222C] px-5 py-6 border border-[#9CA3AD] rounded-lg transform transition ease-in duration-500 overflow-hidden text-white">
