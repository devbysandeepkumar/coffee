...
#4B5668] text-0.5 pt-6">
        ...
        <div className="flex justify-between pt-4">
          <div className="cursor-pointer">
            <h2 className="font-[Poppins] font-medium md:font-semibold lg:font-semibold text-0.5 text-[
#9CA3AD]">
              Price: {coffee?.price}
            </h2>
          </div>
          <div className="cursor-pointer">
            <h2 onClick={()=>navigate(`/recipe/${coffee?.id}`)} className="font-[Poppins] font-medium md:font-semibold lg:font-semibold text-0.5 text-[
#9CA3AD]">
              Know Recipe &nbsp;⟶
            </h2>
          </div>
        </div>
        <button className="ring-1 ring-[
#9CA3AD] rounded-3xl flex items-center text-[
#9CA3AD] font-[Poppins] font-medium text-xs px-4 py-3 mt-5 cursor-pointer">
